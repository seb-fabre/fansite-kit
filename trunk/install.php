...
<body>
	...
	<fieldset style="margin-bottom: 20px">
	    ...
	    <p><label>Database name : </label><input type="text" name="db_name" id="db_name" /><div class="am_formMsgError">The database name is mandatory.</div></p>
	    <p><label>Database login : </label><input type="text" name="db_login" /><div class="am_formMsgError">The database login is mandatory.</div></p>
	    <p><label>Database password : </label><input type="text" name="db_password" /><div class="am_formMsgError">The database password is mandatory.</div></p>
